...
(function($) {
    ...
    var changeTheme = function(name) {
        ...
        if (name == null) {
            $('.main-stylesheet').attr('href', urltheme+'pages/css/pages'+rtl+'.css');
            return;
        }
        $('.main-stylesheet').attr('href', urltheme+'pages/css/themes/' + name + rtl + '.min.css');
    }
    var layoutOption='1';
    var colorOption='1';
    var contentOption='1';
    ...
    if(rtlSwitch !=null){
        rtlSwitch.onchange = function() {
            if(rtlSwitch.checked){
                ...
                $('.main-stylesheet').attr('href', urltheme+'pages/css/pages1.css');
