// $(document).ready(function(){
	$("#bot1").on("tap",function(){
		$.smallBox({
			...
			icon: "notifications/img/origami-50.png",
		});
	});
	...
	$("#bot2").on("tap",function(){
		$.smallBox({
			...
			icon: "notifications/img/invite-50.png",
			color: "#ba007c",
			width: 250,
		});
	...
	$("#bot3").on("tap",function(){
		$.smallBox({
			...
			icon: "notifications/img/christmas_snowflake-50.png",
			color: "#8165a2",
			img: "notifications/img/pic1.png"
		});
	...
	$("#bot7").on("tap",function(){
		...
		$.smallBox({
			...
			title: "Colors",
			content: "Wait a sec..",
			icon: "notifications/img/butterfly-50.png",
	...
	$("#bot9").on("tap",function(){
		...
		$.smallBox({
			...
			icon: "notifications/img/alarm_clock-50.png",
			color: "#ba007c",
			width: 350,
			sound: false,
			closeonclick: false,
