	...
	switch(bbCountDemo){
		case 0:
			$.bigBox({
				...
				img: "notifications/img/close_up_mode-50.png",
				width: 250,
			});
			bbCountDemo = 1;
		break;
		...
		case 1:
			$.bigBox({
				...
				content: "BigBoxes can show a lot of information an has a different behavior",
				img: "notifications/img/night_portrait-50.png",
				color: "#C735E2",
				width: 300,
			});
			bbCountDemo = 2;
		...
		case 2:
			$.bigBox({
				title: "Clipper board",
				content: "BigBoxes can show a lot of information an has a different behavior",
				img: "notifications/img/clipperboard-50.png",
				color: "#1B7CBD",
				width: 350,
			});
			bbCountDemo = 3;
		...
		case 3:
			$.bigBox({
				title: "Leaf",
				content: "BigBoxes can show a lot of information an has a different behavior",
				img: "notifications/img/leaf-50.png",
				color: "#8165A2",
				width: 400,
			});
			bbCountDemo = 4;
		...
		case 4:
			$.bigBox({
				title: "Sports Mode",
				content: "BigBoxes can show a lot of information an has a different behavior",
				img: "notifications/img/sports_mode-50.png",
				color: "#CE6B00",
				width: 450,
			});
			bbCountDemo = 0;
...
$("#botBig3").on("tap",function(){
	...
	$.bigBox({
			...
			title: "Colors",
			content: "Wait a sec..",
			// img: "notifications/img/butterfly-50.png",
...
$("#botBig4").on("tap",function(){
	...
	$.bigBox({
			...
			img: "notifications/img/flower-50.png",
			width: 350,
			timeout: 3000,
			number: "3 seconds"
		});
