...
(function (b) {
    b.smallBox = function (o, j) {
        ...
        if (o.img == undefined) {
            ...
            m = "<div id='smallbox" + SmallBoxes + "' class='SmallBox animated fadeInRight fast'><div class='avatar'><img src='" + o.img + "'></div><div class='textoavatar'><span>" + o.title + "</span><p>" + o.content + "</p></div>" + p + "</div>"
        }
        if(o.top!=undefined)
        {
            top= o.top;
