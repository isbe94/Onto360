...
$(function() {
    ...
    if($('body').data('page') == 'login'){
        ...
        $.backstretch(["/themes/make/assets/images/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["/themes/make/assets/images/gallery/login4.jpg", "/themes/make/assets/images/gallery/login3.jpg", "/themes/make/assets/images/gallery/login2.jpg", "/themes/make/assets/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
