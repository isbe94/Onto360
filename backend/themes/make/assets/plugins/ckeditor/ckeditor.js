...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    p.fn = d;
                    p.priority = h;
                    for (var u = f.length - 1; 0 <= u; u--)if (f[u].priority <= h)return f.splice(u + 1, 0, p), {removeListener: r};
                    f.unshift(p)
                }
            ...
            once: function () {
                ...
                return function (h, p, r) {
                    ...
                    if (f) {
                        var u = f.listeners;
                        if (u.length)for (var u = u.slice(0), z, y = 0; y < u.length; y++) {
                            if (f.errorProof)try {
                                z =
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, h = {
            lt: "\x3c",
            gt: "\x3e",
            amp: "\x26",
            quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                var b = f == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")), c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = f == CKEDITOR.ENTER_P ? "p" : "div";
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var m = "\x3c" + h + "\x3e", p = "\x3c/" + h + "\x3e", c = m + c.replace(d, function () {
                            return p + m
                        }) + p
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            createClass: function (a) {
                var f = a.$, b = a.base, c = a.privates || a._, h = a.proto;
                a = a.statics;
                !f && (f = function () {
            ...
            normalizeCssText: function (a, f) {
                var b = [], c, h = CKEDITOR.tools.parseCssText(a, !0, f);
            ...
            keystrokeToString: function (a, b) {
                var c = b & 16711680, h =
                    b & 65535, d = CKEDITOR.env.mac, p = [], m = [];
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, h, d = 0; d < b.length; d++)if (c = b[d].split("\x3d"), h = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), h === a)return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    ...
                    for (c = 0; c < a.length; c++)var h = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36), b = b + (.5 < Math.random() ? h.toUpperCase() : h);
                    a = b;
            ...
            style: {
                parse: {
                    ...
                    margin: function (a) {
                        ...
                        var c = {}, h = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
                        switch (h.length) {
                            case 1:
                                b([0, 0, 0, 0]);
                                break;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, h = {"#": 1}, p = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        ...
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                if (d)for (var g = -1, k = 0; k < b.childNodes.length; k++) {
                    ...
                    if (!0 !== d || 3 != h.nodeType || !h.previousSibling || 3 != h.previousSibling.nodeType)if (g++, g == e) {
                        b = h;
                        break
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a)b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (f)for (var u =
                        0; u < f.length; u++)b.push([a, c[d], f[u]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                var b = 0, c = 0, f = this.getDocument(), d = f.getBody(), u = "BackCompat" == f.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    8 !== CKEDITOR.env.version : 1)) {
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement, m = g.clientTop || d.$.clientTop || 0, x = g.clientLeft || d.$.clientLeft || 0, k = !0;
                ...
                } else for (m = this, x = null; m && "body" != m.getName() &&
                "html" != m.getName();) {
                ...
                e = a.getWindow();
                d = m(this, e);
                var w = m(a, e), F = this.$.offsetHeight;
                f = this.$.offsetWidth;
                var l = a.$.clientHeight, q = a.$.clientWidth;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, B = c.endOffset, g, l = this.guard, q = this.type, n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var t = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), A = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(B) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !t.equals(a)) && (!A || !a.equals(A)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var C = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), h = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp(), p = function (a) {
        ...
        var f = CKEDITOR.dom.walker.empty(), B = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            var q = a.startContainer, n = a.endContainer,
                t = a.startOffset, A = a.endOffset, C, D, M, H, p, Q;
            if (l && n.type == CKEDITOR.NODE_TEXT && q.equals(n))q = a.document.createText(q.substring(t, A)), c.append(q); else {
                ...
                K = c;
                for (S = G; S <= I; S++)if (c = v[S], X = c.getPrevious(), c.equals(P[S]))b && (K = K.getChild(0)); else {
        ...
        var g = {
            ...
            u: 1,
            "var": 1
        }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, p = CKEDITOR.dom.walker.editable(), r = CKEDITOR.dom.walker.ignored(!0);
            ...
            clone: function () {
                ...
                if ((!a ||
                    ...
                    if (d)if (d >= c.getLength())d = c.getIndex() + 1, c = c.getParent(); else {
                        var m = c.split(d), d = c.getIndex() + 1, c = c.getParent();
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var g = this.getCommonAncestor(), h = this.root, k, r, l, q, n, t = !1, A, C;
                        ...
                        for (l = c(l); l || q;) {
                            ...
                            for (; q;)if (A = !1, q.type == CKEDITOR.NODE_COMMENT)q = q.getPrevious(); else {
                                if (q.type == CKEDITOR.NODE_TEXT)C = q.getText(), d.test(C) && (q = null), A = /[\s\ufeff]$/.test(C); else if ((q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && q.is("br")) && !q.data("cke-bookmark"))if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    C = q.getText();
                                    if (d.test(C))q = null; else for (var D = q.$.getElementsByTagName("*"), M = 0, H; H =
                                        D[M++];)if (!CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]) {
                                        q = null;
                                        break
                                    }
                                    q && (A = !!C.length)
                        ...
                        for (; l ||
                            ...
                            for (; q;) {
                                A = !1;
                                if (q.type == CKEDITOR.NODE_TEXT)C = q.getText(), m(q, 0) || (q = null), A = /^[\s\ufeff]/.test(C); else if (q.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < q.$.offsetWidth || b && q.is("br")) && !q.data("cke-bookmark"))if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                        C = q.getText();
                                        if (d.test(C))q = null; else for (D = q.$.getElementsByTagName("*"), M =
                                            0; H = D[M++];)if (!CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]) {
                                            q = null;
                                            break
                                        }
                                        q && (A = !!C.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var p, Q, P = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), v = null, G = function (a) {
                            if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))if (v) {
                                if (v.equals(a)) {
                                    v = null;
                                    return
                                }
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var E = CKEDITOR.dom.walker.whitespaces(), I = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, m = this.endContainer, g = this.startOffset, h = this.endOffset, k = 1, r = 1;
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, m = d.block, g = null;
                ...
                var c, d = 0, e, m, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block))d = 1; else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]())d = 1, (m = e.type == CKEDITOR.NODE_ELEMENT) &&
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], m, g, h, k;
                if (c && c.find)for (g = c.find(a), m = 0; m < g.count(); m++)if (c = g.getItem(m), b || !c.isReadOnly())h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                h && k && e.push(c);
                return e
            }
        }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = m.startPath();
                    var x = m.endPath(), J = !m.collapsed && c(m, k.block), w = !m.collapsed && c(m, x.block, 1);
                ...
                for (this._.nextNode = null; x;) {
                    var J = 0, w = x.hasAscendant("pre"), F = x.type != CKEDITOR.NODE_ELEMENT, l = 0;
                    if (F)x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (F = 0); else {
                        var q = x.getName();
                        if (CKEDITOR.dtd.$block[q] && "false" == x.getAttribute("contenteditable")) {
                            ...
                            if ("br" == q)F = 1; else if (!k && !x.getChildCount() && "hr" != q) {
                                d = x;
                                u = x.equals(m);
                                break
                            }
    ...
    (function () {
        function a(a, b, c, d, l) {
            ...
            for (e in b) {
                ...
                for (t in Q) {
                    n[t] = k(n[t], f) || null;
                    var m = n, g = P[t], E = k(n[P[t]], f), v = n[t], A = [], I = !0, C = void 0;
                    E ? I = !1 : E = {};
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, l = !0 === a, q = b.length; q--;)if (l || a(b[q]))b.splice(q, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function h(a, b) {
            ...
            var c, d, l, e;
            if (l = a.requiredClasses)for (e = b.classes, c = 0; c < l.length; ++c)if (d = l[c], "string" == typeof d) {
        ...
        function f(a) {
            var b, c, d, l, e = {}, q = 1;
            for (a = H(a); b = a.match(v);)(c = b[2]) ? (d = B(c, "styles"), l = B(c, "attrs"), c = B(c, "classes")) : d = l = c = null, e["$" + q++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: l
        ...
        function z(a, b, l, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var t = 0, g = f.length, v; t < g; ++t)if (v = f[t](b)) {
                        f = v;
                        break a
                    }
                    f = void 0
            ...
            if (e.doFilter) {
                a:{
                    ...
                    if (a || f) {
                        u(b);
                        if (t)for (k = 0, C = t.length; k < C; ++k)if (!1 === c(t[k], b, A)) {
                            a = null;
                            break a
                        }
                ...
                var h = a.validStyles;
                f = a.validClasses;
                var t = b.attributes, M = b.styles, g = b.classes;
                v = b.classBackup;
                var K = b.styleBackup, G, D, p = [], A = [], H = /^data-cke-/;
                k = !1;
                delete t.style;
                delete t["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (G in t)C[G] || (H.test(G) ? G == (D = G.replace(/^data-cke-saved-/, "")) || C[D] || (delete t[G], k = !0) : (delete t[G], k = !0));
        ...
        function l(a, b, c) {
            var d = a.name;
            if (D.$empty[d] || !a.children.length)"hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (D.$block[d] || "tr" == d)if ("br" == b)a.previous && !F(a.previous) && (b = w(), b.insertBefore(a)), a.next && !F(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, l;
                b:{
                    l = D[b];
                    for (var e = 0, q = d.length, n; e < q; ++e)if (n = d[e], n.type == CKEDITOR.NODE_ELEMENT && !l[n.name]) {
                        l = !1;
                        break b
                    }
                    l = !0
                }
                if (l)a.name = b, a.attributes =
                {}, c.push({check: "parent-down", el: a}); else {
                    l = a.parent;
                    for (var e = l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == l.name, t, f, q = d.length; 0 < q;)n = d[--q], e && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && D.$inline[n.name]) ? (t || (t = new CKEDITOR.htmlParser.element(b), t.insertAfter(a), c.push({
                        check: "parent-down",
                        el: t
                    })), t.add(n, 0)) : (t = null, f = D[l.name] || D.span, n.insertAfter(a), l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || f[n.name] || c.push({
                        check: "el-up",
                        el: n
                    }));
                    a.remove()
        ...
        function q(a, b, c) {
            var d, l;
            for (d = 0; d < c.length; ++d)if (l = c[d], !(l.check && !a.check(l.check, !1) || l.left && !l.left(b))) {
                l.right(b, K);
                break
            }
        }
        ...
        function n(a, b) {
            var c = b.getDefinition(), d = c.attributes, l = c.styles, e, q, n, t;
            if (a.name != c.element)return !1;
            for (e in d)if ("class" == e)for (c = d[e].split(/\s+/), n = a.classes.join("|"); t = c.pop();) {
                if (-1 == n.indexOf(t))return !1
            } else if (a.attributes[e] != d[e])return !1;
            for (q in l)if (a.styles[q] !=
                l[q])return !1;
            return !0
        }
        ...
        var D = CKEDITOR.dtd, M = CKEDITOR.tools.copy, H = CKEDITOR.tools.trim, R = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, q = [], n = this.editor && this.editor.config.protectedSource, t, f = !1, g = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (t = z(e, a, q, g), t & 1)f = !0; else if (t & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var l, m, E;
                            if (n)for (m = 0; m < n.length; ++m)if ((E = d.match(n[m])) && E[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, l, c, g);
                            c = !c.length
                        }
                        c || q.push(a)
                    }
                ...
                for (; m = a.pop();)if (c = m.el, c.parent)switch (E = D[c.parent.name] || D.span, m.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                var b, c;
                if (!this.disabled && a) {
                    var d = this._.transformations, l;
                    for (l = 0; l < a.length; ++l) {
                        b = a[l];
                        var e = void 0, q = void 0, n = void 0, t = void 0, f = void 0, g = void 0;
                        c = [];
                        for (q = 0; q < b.length; ++q)n = b[q], "string" == typeof n ? (n = n.split(/\s*:\s*/), t = n[0], f = null, g = n[1]) : (t = n.check, f = n.left, g = n.right), e || (e = n, e = e.element ? e.element : t ? t.match(/^([a-z0-9]+)/i)[0] :
                            e.left.getDefinition().element), f instanceof CKEDITOR.style && (f = A(f)), c.push({
                            check: t == e ? null : t,
                            left: f,
                ...
                if ("string" == typeof a) {
                    ...
                    l = d
                } else d = a.getDefinition(), l = d.styles, n = d.attributes || {}, l && !CKEDITOR.tools.isEmpty(l) ? (l = M(l), n.style = CKEDITOR.tools.writeCssText(l, !0)) : l = {}, l = {
                    name: d.element,
                    attributes: n,
                ...
                var n = CKEDITOR.tools.clone(l), t = [], g;
        ...
        var Q = {styles: 1, attributes: 1, classes: 1}, P = {
                styles: "requiredStyles",
                attributes: "requiredAttributes",
                classes: "requiredClasses"
            }, v = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, G = {
                styles: /{([^}]+)}/,
                attrs: /\[([^\]]+)\]/,
                classes: /\(([^\)]+)\)/
            }, E = /^cke:(object|embed|param)$/,
            I = /^(object|embed|param)$/, K;
        K = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b)a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, l = c.attributes, e, q, n, t;
                    a.name = c.element;
                    for (e in l)if ("class" ==
                        e)for (c = a.classes.join("|"), n = l[e].split(/\s+/); t = n.pop();)-1 == c.indexOf(t) && a.classes.push(t); else a.attributes[e] = l[e];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                k && (b = [b]);
                e || (e = CKEDITOR);
                var h = b.length, p = [], r = [], f = function (a) {
                        ...
                        if (a[b])B(b, !0); else {
                            ...
                            if (!(1 < e.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function () {
                                    if ("loaded" == f.$.readyState || "complete" == f.$.readyState)f.$.onreadystatechange = null, u(b, !0)
                                } : (f.$.onload = function () {
                                    var toutMs = 5000;
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], k = {}, h = {}, p = 0; p < a.length; p++) {
                var r = a[p];
                if (r)if (c[r] || e[r])h[r] = this.get(r); else {
            ...
            CKEDITOR.scriptLoader.load(g, function (a, e) {
                ...
                for (var f = 0; f < a.length; f++)for (var g = k[a[f]], m = 0; m < g.length; m++) {
                    var x = g[m];
                    h[x] = this.get(x);
                    c[x] = 1
                }
        ...
        return function (b, c, e) {
            var g = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var h = a[f], u = h && h.requires;
                        if (!d[f]) {
                            if (h.icons)for (var z = h.icons.split(","), y = z.length; y--;)CKEDITOR.skin.addIcon(z[y], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[y] + ".png");
                            d[f] = 1
                        }
                        if (u)for (u.split && (u = u.split(",")), h = 0; h < u.length; h++)g[u[h]] || b.push(u[h])
                    }
    ...
    (function () {
        ...
        function B(a) {
            var b = a.config, c = b.plugins, d = b.extraPlugins, e =
                b.removePlugins;
            if (d)var l = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(l, ""), c = c + ("," + d);
            if (e)var q = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(q, "");
            CKEDITOR.env.air && (c += ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function (c) {
                var d = [], l = [], e = [];
                a.plugins = c;
                for (var f in c) {
                    var g = c[f], k = g.lang, h = null, p = g.requires, r;
                    CKEDITOR.tools.isArray(p) && (p = p.join(","));
                    if (p && (r = p.match(q)))for (; p = r.pop();)CKEDITOR.error("editor-plugin-required",
                        {plugin: p.replace(",", ""), requiredBy: f});
            ...
            function (g, k, h) {
                function p(a) {
                    ...
                    if (0 < x.length)for (var c = 0; c < x.length; c++) {
                        var d = x[c], l = d.name, e = CKEDITOR.dtd[l], f = w.name && CKEDITOR.dtd[w.name];
                ...
                var y = new CKEDITOR.htmlParser, m = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, x = [], J = [], w = m, F = "textarea" == m.name, l = "pre" == m.name;
                y.onTagOpen = function (e, n, f, g) {
                    ...
                    if (a(n))x.push(n); else {
                        ...
                        if ("br" == e)J.push(n); else {
                            for (; !(g = (f = w.name) ? CKEDITOR.dtd[f] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || w.isUnknown || g[e]);)if (w.isOptionalClose)y.onTagClose(f); else if (e in b && f in b)f = w.children, (f = f[f.length - 1]) && "li" == f.name || B(f = new CKEDITOR.htmlParser.element("li"), w), !n.returnPoint && (n.returnPoint = w), w = f; else if (e in CKEDITOR.dtd.$listItem && !z(e, f))y.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !z(e, f))!n.returnPoint && (n.returnPoint = w), w = w.parent; else if (f in CKEDITOR.dtd.$inline && x.unshift(w), w.parent)B(w, w.parent, 1); else {
                                n.isOrphan = 1;
                                break
                            }
                            p(e);
                ...
                y.onText = function (a) {
                    ...
                    if (!F && !f["#"] && b in d)y.onTagOpen(e[b] || ""), y.onText(a); else {
                        r();
                        p();
                        l || F || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, p, r, f, B;
                for (B = 0; B < h; B++)if (d && (p = c.type, r = c.name), f = k[B], !(a.nonEditable && !f.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function n(a, d) {
                return function (l) {
                    if (l.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [], n = b(l), t, E;
                        if (n)for (q(n, 1) && e.push(n); n;)g(n) && (t = c(n)) && q(t) && ((E = c(t)) && !g(E) ? e.push(t) : (f(v).insertAfter(t), t.remove())), n = n.previous;
            ...
            var t = {elements: {}}, v = "html" == d, h = CKEDITOR.tools.extend({}, l), A;
            ...
            return a.replace(C,
                function (a, b, c) {
                    return "\x3c" + b + c.replace(D, function (a, b) {
                            return M.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a
                        }) + "\x3e"
                })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, l, c = m(c, b), c = f(c, R), c = r(c), c = f(c, H), c = c.replace(P, "$1cke:$2"), c = c.replace(G, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        }, n = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, t = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
            ...
            elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/,
                ...
                $: function (a) {
                    ...
                    a.children.slice(0).sort(function (a, b) {
                        var c, d;
                        a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(F, a.name), d = CKEDITOR.tools.indexOf(F, b.name));
        ...
        var C = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, M = /^(href|src|name)$/i, H = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var p, r;
                for (p in k) {
                    for (h = k[p]; ;)if (r = a.onAttributeName(b, p))if (r != p)delete k[p], p = r; else break; else {
                        delete k[p];
                        break
                    }
                ...
                b && this.filter(b);
                var g = this.name, k = [], h = this.attributes, p, r;
                a.openTag(g, h);
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, k = a.elementMode, h =
                    a.fire("uiSpace", {space: "top", html: ""}).html, p = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var h = d.checkDirty(), k = d._.previousModeData, p, r = 0;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var h = this.container, p = this.ui.space("contents"), r = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, h = g.getRanges()[0], D;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (g = d(g, e))g.appendBogus(), D = CKEDITOR.env.ie;
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
                        ...
                        thead: 1,
                        tfoot: 1
                    }) ? x(b) : b.startContainer.is(CKEDITOR.dtd.$list) && J(b));
                    var g, k;
                    ...
                    function a() {
                        var b = c.getDocument().$, d = b.getSelection(), l;
                        a:if (d.anchorNode && d.anchorNode == c.$)l = !0; else {
                            if (CKEDITOR.env.webkit && (l = c.getDocument().getActive()) && l.equals(c) && !d.anchorNode) {
                                l = !0;
                                break a
                            }
                            l = void 0
                    ...
                    function b() {
                        var a = c.getDocument().$, d = a.selection, l = c.getDocument().getActive();
                    ...
                    var c = F, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var t = e.getHead(), h = t.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in D) {
                                b = a.getSelection();
                                var e,
                                    n = b.getRanges()[0], q = n.startPath(), t, k, h, c = 8 == c;
        ...
        m = function () {
            ...
            function b(c, d) {
                var e, f, n, t, g = [], k = d.range.startContainer;
                e = d.range.startPath();
                ...
                "br" != n || !e.data("cke-eol") || h && h != A - 1 || (r = (f = h ? g[h - 1].node : C.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && p.$block[f.getName()]), -1 != D || t || (D = h), t || (m = h), g.push({
                    isElement: 1,
                    isLineBreak: r,
                    ...
                    name: n,
                    allowed: t
                }), f = r = 0)) : g.push({isElement: 0, node: e, allowed: 1});
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), q = f.count(), g, t = 0, k = p[c], h = !b.is(p.$inline) || b.is("br");
            ...
            var p = CKEDITOR.dtd, m = {
                ...
                dl: 1,
                blockquote: 1
            }, r = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, x = CKEDITOR.tools.extend({},
                p.$inline);
            delete x.br;
            return function (m, v, G, E) {
                ...
                if (!E.checkReadOnly()) {
                    ...
                    if (!v.collapsed) {
                        var I = L.block || L.blockLimit, B = v.getCommonAncestor();
                        I && !I.equals(B) && !I.contains(B) && v.checkEndOfBlock() && m.zombies.push(I);
                        v.deleteContents()
                    }
                    for (; (u = e(v)) && a(u) && u.isBlockBoundary() && K.contains(u);)v.moveToPosition(u, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    if (H = G) {
                        ...
                        if ((z = H.startPath().block) && (1 != z.getChildCount() || !z.getBogus()))a:{
                            ...
                            if (1 ==
                                ...
                                H = 0;
                                for (E = z.count(); H < E; H++)if (v = z.getItem(H), !v.is(x))break a;
                    ...
                    if (H) {
                        ...
                        var F, J;
                        v = w.startContainer;
                        var K = m.endPath.elements[0], Y, L = K.getPosition(v), B = !!K.getCommonAncestor(v) && L != CKEDITOR.POSITION_IDENTICAL && !(L & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        v = b(m.dataWrapper, m);
                        for (D(v, w); E < v.length; E++) {
                            ...
                            if (y = L.isLineBreak) {
                                y = w;
                                F = u;
                                var U = void 0, aa = void 0;
                                L.hasBlockSibling ? y = 1 : (U = y.startContainer.getAscendant(p.$block, 1)) && U.is({
                                    div: 1,
                                    p: 1
                                }) ? (aa = U.getPosition(F), aa == CKEDITOR.POSITION_IDENTICAL || aa == CKEDITOR.POSITION_CONTAINS ? y = 0 : (F = y.splitElement(U), y.moveToPosition(F, CKEDITOR.POSITION_AFTER_START), y = 1)) : y = 0
                            }
                            if (y)G = 0 < E; else {
                                y = w.startPath();
                                ...
                                if (I && L.isElement) {
                                    ...
                                    if (y)F && (J = w.splitElement(F), m.zombies.push(J), m.zombies.push(F)); else {
                                        F = u.getName();
                                        Y = !E;
                                        y = E == v.length - 1;
                                        F = d(L.node, F);
                    ...
                    if (J)for (; N = J.pop();)CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(O.document.createText(" "));
        ...
        w = {
            eol: {
                detect: function (a, b) {
                    var c = a.range,
                        d = c.clone(), e = c.clone(), f = new CKEDITOR.dom.elementPath(c.startContainer, b), g = new CKEDITOR.dom.elementPath(c.endContainer, b);
                    d.collapse(1);
                    e.collapse();
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(), l = e.contains(CKEDITOR.dtd.$list), g = f.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode, f = new CKEDITOR.dom.elementPath(d, c), l = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                                var g = f.contains(CKEDITOR.dtd.$list), n = l.contains(CKEDITOR.dtd.$list);
                    ...
                    detectMerge: function (a,
                        ...
                        if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                            var d = a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode, f = new CKEDITOR.dom.elementPath(d, c), l = new CKEDITOR.dom.elementPath(e, c), f = f.block, l = l.block;
                    ...
                    function a(c) {
                        var e =
                            [], f, l = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), n = c.endPath().contains(d), k = {};
                        l.guard = function (a, l) {
                            ...
                            if (l && g && a.equals(g))f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!l && n && a.equals(n))f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var l = c(f, e.bookmark), g = l.clone(), k, h, v = l.getCommonAncestor();
    ...
    (function () {
        ...
        function k(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), e = d && "None" != d.type && d.getRangeAt(0), f = z.length;
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, l = CKEDITOR.document, g = e.editable(), h = f.getBody(), q = f.getDocumentElement(), m = g.isInline(), p, v;
                ...
                if (CKEDITOR.env.ie && !m) {
                    ...
                    g.attachListener(g, "mousedown", function (a) {
                        2 == a.data.$.button && ((a = e.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (G = e.window.getScrollPosition()))
                    });
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version)q.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (l.on("mouseup", c), q.on("mouseup", c))
                        })
                    }
                }
            ...
            getNative: function () {
                ...
                var a = B ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, l, g = b.duplicate(), h = 0, k = e.length - 1, v = -1, n, m; h <= k;)if (v = Math.floor((h + k) / 2), f = e[v], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n)k = v - 1; else if (0 > n)h = v + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                ...
                var b = this.getNative(), b = B ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    a:{
                        var m, p;
                        if (1 == a.length && !(p = a[0]).collapsed && (h = p.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT && (p = p.clone(), p.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (m = p.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (h = m), "false" == h.getAttribute("contenteditable")))break a;
                        h = void 0
                    }
                        ...
                        if (B) {
                            ...
                            for (y = 0; y < a.length; y++) {
                                ...
                                try {
                                    ...
                                    if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))h.collapse(1), u.setEnd(h.endContainer.$, h.endOffset); else throw v;
                                }
                                f.addRange(u)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed)f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var p = c.createBookmark(), q = p.startNode, r = p.endNode, u = q, t;
                if (!k) {
                    var w = c.getCommonAncestor(), k = a(q, w), w = a(r, w);
                    k && (u = k.getNextSourceNode(!0));
                    w && (r = w)
                }
                for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
                    k = !1;
                    if (u.equals(r))u = null, k = !0; else {
                        ...
                        if (w && m && CKEDITOR.dtd.$block[z])for (var B = u, A = e(B), C = void 0, D = A.length, F = 0, B = D && new CKEDITOR.dom.range(B.getDocument()); F < D; ++F) {
                            var C = A[F], M = CKEDITOR.filter.instances[C.data("cke-filter")];
                            if (M ? M.check(this) : 1)B.selectNodeContents(C), b.call(this, B)
                        }
                        A = z ? !n[z] || x ? 0 : w && !m ? 0 : d(u, r, h, Q) : 1;
                        if (A)if (C = u.getParent(), A = h, D = g, F = l, !C || !(C.getDtd() || CKEDITOR.dtd.span)[D] && !F || A.parentRule && !A.parentRule(C))k = !0; else {
                            if (t ||
                                ...
                                for (var z = u, R; (k = !z.getNext(H)) && (R = z.getParent(), n[R.getName()]) && d(R, q, h, P);)z = R;
                                t.setEndAfter(z)
                            }
                        } else k = !0;
        ...
        function y(a) {
            ...
            for (var f in b)if (f != this.element)for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || m(d, b[f])
        }
        ...
        var A = {
            ...
            audio: 1,
            video: 1
        }, D = /\s*(?:;\s*|$)/, M = /#\((.+?)\)/g, H = CKEDITOR.dom.walker.bookmark(0,
            1), R = CKEDITOR.dom.walker.whitespaces(1);
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, e) {
            var g = null, k = null, h = [], p = b, r;
            e = e || b.getDocument().getBody();
            do if (p.type == CKEDITOR.NODE_ELEMENT) {
                h.push(p);
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, k = c[d ? "endContainer" : "startContainer"], h = d ? "endOffset" : "startOffset", p = g ? c.document.getById(a.startNode) : a.startNode;
            ...
            createIterator: function () {
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        var h = a[g];
                        if (h && 1 < a.length) {
                            if (!g)for (var p = a.length - 1; 0 <= p; p--)d.unshift(a[p].createBookmark(!0));
                            if (k)for (var r = 0; a[g + r + 1];) {
                                var f = h.document;
                                k = 0;
                                ...
                                for (f = f.getById(d[r + 1].startNode); ;) {
                                    ...
                                    if (f.equals(p))k = 1; else if (c(p) || p.type == CKEDITOR.NODE_ELEMENT && p.isBlockBoundary())continue;
                                    break
                                }
                                if (!k)break;
                                r++
    ...
    (function () {
        ...
        var k = "cke_ui_color", h = [], p = /\$color/g;
    ...
    (function () {
        ...
        function Y(a) {
            function b(b) {
                var c = a.getSize(), k = CKEDITOR.document.getWindow().getViewPaneSize(), q = b.data.$.screenX, n = b.data.$.screenY, r = q - e.x, l = n - e.y;
                e = {x: q, y: n};
                d.x += r;
                d.y += l;
            ...
            var e = null, d = null, f = a.getParentEditor(), g = f.config.dialog_magnetDistance, h = CKEDITOR.skin.margins || [0, 0, 0, 0];
        ...
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                var e = this._.element.getFirst(), d = "rtl" == this._.editor.lang.dir, f = "fixed" == e.getComputedStyle("position");
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, e, d, f, g) {
                    if (!(4 > arguments.length)) {
                        var h = (e.call ? e(b) : e) ||
                            "div", p = ["\x3c", h, " "], m = (d && d.call ? d(b) : d) || {}, k = (f && f.call ? f(b) : f) || {}, q = (g && g.call ? g.call(this, a, b) : g) || "", n = this.domId = k.id || CKEDITOR.tools.getNextId() + "_uiElement";
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, g = d && d.widths || null, h = d && d.height || null, p, m = {role: "presentation"};
    ...
    (function () {
        ...
        function z(b) {
            function a() {
                ...
                "beforepaste" == m.mainPasteEvent && (a.on("paste", function (a) {
                    v || (f(), a.data.preventDefault(), u(a), d("paste") || b.openDialog("paste"))
            ...
            function c(a) {
                return {
                    ...
                    exec: function () {
                        ...
                        var a;
                        var c = this.type;
                        if (CKEDITOR.env.ie)a = d(c); else try {
            ...
            function d(a) {
                var c = b.document, d = c.getBody(), g = !1, e = function () {
                    g = !0
                };
                d.on(a, e);
            ...
            function n(a, c) {
                var d = b.document, g = b.editable(), e = function (b) {
                    b.cancel()
                }, h;
                if (!d.getById("cke_pastebin")) {
                    var k = b.getSelection(), u = k.createBookmarks();
            ...
            function u(a) {
                ...
                d && m.canClipboardApiBeTrusted(c.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function () {
                    q(b, c)
                }, 0)) : n(a, function (a) {
            ...
            var m = CKEDITOR.plugins.clipboard, p = 0, v = 0, x = 0;
            (function () {
                b.on("key", k);
                b.on("contentDom", a);
        ...
        function F(b) {
            ...
            b.on("contentDom", function () {
                ...
                var d = b.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(b), n = b.ui.space("top"), w = b.ui.space("bottom");
                ...
                d.attachListener(b, "dragstart", function (d) {
                ...
                d.attachListener(h, "drop", function (d) {
                    if (!d.data.$.defaultPrevented) {
                        ...
                        if (!c.isReadOnly() || c.type == CKEDITOR.NODE_ELEMENT && c.is("html")) {
                            var c = a.getRangeAtDropPosition(d, b), g = a.dragRange;
                            c && f(d, g, c)
                        }
                    }
                }, null, null, 9999);
                ...
                d.attachListener(b, "drop", function (d) {
                    if (d = d.data) {
                        var g = d.dropRange, h = d.dragRange, f = d.dataTransfer;
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (b) {
                ...
                b.on("paste", function (a) {
                    ...
                    if (!a.data.dataValue) {
                        var d = a.data.dataTransfer, c = d.getData("text/html");
                        if (c)a.data.dataValue = c, a.data.type = "html"; else if (c = d.getData("text/plain"))a.data.dataValue = b.editable().transformPlainTextToHtml(c), a.data.type = "text"
                    }
                }, null, null, 1);
                b.on("paste", function (a) {
                ...
                b.on("paste", function (a) {
                    a = a.data;
                    var d = a.type, e = a.dataValue, f, p = b.config.clipboard_defaultContentType || "html", k = a.dataTransfer.getTransferType(b);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            isDropRangeAffectedByDragRange: function (b,
                                                      a) {
                var c = a.startContainer, e = a.endOffset;
            ...
            internalDrop: function (b, a, c, e) {
                var f = CKEDITOR.plugins.clipboard, g = e.editable(), d, h;
                e.fire("saveSnapshot");
            ...
            getRangeAtDropPosition: function (b, a) {
                var c =
                    b.data.$, e = c.clientX, f = c.clientY, g = a.getSelection(!0).getRanges()[0], d = a.createRange();
                if (b.data.testRange)return b.data.testRange;
                if (document.caretRangeFromPoint)c = a.document.$.caretRangeFromPoint(e, f), d.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), d.collapse(!0); else if (c.rangeParent)d.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), d.collapse(!0); else {
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                var t = a.document.$.elementFromPoint(e, f), m = new CKEDITOR.dom.element(t), q;
                                if (m.equals(a.editable()) || "html" == m.getName())return g && g.startContainer && !g.startContainer.equals(a.editable()) ? g : null;
                                q = m.getClientRect();
            ...
            initDragDataTransfer: function (b, a) {
                var c = b.data.$ ? b.data.$.dataTransfer : null, e = new this.dataTransfer(c, a);
    ...
    (function () {
        ...
        var h = h + (' onmouseover\x3d"CKEDITOR.tools.callFunction({hoverFn},{index});" onmouseout\x3d"CKEDITOR.tools.callFunction({moveOutFn},{index});" ' + (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},{index}); return false;"\x3e'), r = CKEDITOR.addTemplate("menuItem",
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                onShow: function () {
                    var a = this.editor.getSelection(), b = a && a.getStartElement(), d = this.editor.elementPath(), m = this._.listeners;
                    this.removeAll();
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, d) {
                ...
                render: function (a, b, d) {
                    var h = a.id + String(b), g = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state, k = "", e = this.editor, f, c, l = g == CKEDITOR.TRISTATE_ON ? "on" : g == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off";
                    this.role in {
                        menuitemcheckbox: 1,
                        menuitemradio: 1
                    } && (k = ' aria-checked\x3d"' + (g == CKEDITOR.TRISTATE_ON ? "true" : "false") + '"');
                    var u = this.getItems, q = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", p = this.name;
    ...
    (function () {
        ...
        var c = c + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" ' + (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{style}"'), c = c + '\x3e\x26nbsp;\x3c/span\x3e\x3cspan id\x3d"{id}_label" class\x3d"cke_button_label cke_button__{name}_label" aria-hidden\x3d"false"\x3e{label}\x3c/span\x3e\x3cspan id\x3d"{id}_description" class\x3d"cke_button_label" aria-hidden\x3d"false"\x3e{ariaShortcut}\x3c/span\x3e{arrowHtml}\x3c/a\x3e',
            t = CKEDITOR.addTemplate("buttonArrow", '\x3cspan class\x3d"cke_button_arrow"\x3e' + (CKEDITOR.env.hc ? "\x26#9660;" : "") + "\x3c/span\x3e"), u = CKEDITOR.addTemplate("button", c);
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (a) {
                var d, g = function (c, h) {
                    var b, e = "rtl" == a.lang.dir, k = a.config.toolbarGroupCycling, q = e ? 37 : 39, e = e ? 39 : 37, k = void 0 === k || k;
                    switch (h) {
                        case 9:
        ...
        addMenuItems: function (a) {
            ...
            a.plugins.wsc && (b.WSC = {
                label: a.lang.wsc.toolbar, group: "scaytButton", onClick: function () {
                    var b = CKEDITOR.plugins.scayt,
                        d = a.scayt, c = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText();
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0, e = "all options lang ignore-all-caps-words ignore-domain-names ignore-words-with-mixed-cases ignore-words-with-numbers".split(" "), f = ["lang", "ignore-all-caps-words",
                    "ignore-domain-names", "ignore-words-with-mixed-cases", "ignore-words-with-numbers"], g = CKEDITOR.tools.search, h = CKEDITOR.tools.indexOf;
            ...
            var c = CKEDITOR.plugins.scayt, d = a.dataProcessor, b = d && d.htmlFilter,
                e = a._.elementsPath && a._.elementsPath.filters, d = d && d.dataFilter, f = a.addRemoveFormatFilter, g = function (b) {
            ...
            var d = a.scayt, b = this.scaytMenuDefinition(a), e = {}, f = a.config.scayt_contextCommands.split("|"), g = c.getAttribute(d.getLangAttribute()) || d.getLang(), h, k;
            h = d.isScaytNode(c);
            k =
                d.isGraytNode(c);
