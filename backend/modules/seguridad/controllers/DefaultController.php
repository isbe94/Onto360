<?php
/*Clase del Controladora del Modulo seguridad*/
...
class DefaultController extends Controller 
{
    ...
    public function actionIndex()
    {
		if (\Yii::$app->request->getIsAjax())
          ...
          return $this->getView()->render('@backend/modules/seguridad/views/default/index');
		 } 
		 else
		 {
    ...
    {
        return $this->getView()->render('@backend/modules/seguridad/views/default/load');
    }
}
